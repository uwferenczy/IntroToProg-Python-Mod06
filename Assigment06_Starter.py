...
class Processor:
    ...
    def add_data_to_list(task, priority, list_of_rows):
        ...
        :return: (list) of dictionary rows
        """
        dic_row_tmp = {"Task": task, "Priority": priority}
        list_of_rows.append(dic_row_tmp)
        print(task, "was added successfully")
        return list_of_rows, 'Success'

    @staticmethod
    def remove_data_from_list(task, list_of_rows):
        """ Remove data from a list of dictionary rows

        :param task: (string) task to be removed:
        :param list_of_rows: (list) list you want to remove the task from:
        :return: (list) of dictionary rows
        """
        bool_removed = False
    ...
    def write_data_to_file(file_name, list_of_rows):
        """ Write data from a list of dictionary rows to a file

        :param file_name: (string) with name of file:
        :param list_of_rows: (list) list you want to write from:
        :return: (list) of dictionary rows
        """
        ...
        for row in list_of_rows:
            task = row.get("Task")
            priority = row.get("Priority")
            dic_row = f'{task},{priority}\n'
            txt_file.write(dic_row)
        txt_file.close()
